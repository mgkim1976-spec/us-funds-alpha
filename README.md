...
신호는 두 소스에서 나옵니다: **뮤추얼펀드(N-PORT, ~540 액티브 US 주식형)** 와 **헤지펀드(13F 집중 매니저, ~3,100)**. 비교하면 강점이 다릅니다 — *폭넓은 보유·신규매수는 뮤추얼펀드*, *집중된 고확신(Best-Ideas)은 헤지펀드*가 우월합니다. 각 소스의 승자 신호만 결합한 **결합 앙상블(MF의 mhw·lnp + HF의 best-ideas)** 이 가장 높은 알파(+13.8%, t3.92)를 냅니다.
...
자체 완결형 일일 모니터(`dashboard/index.html`, 밝은 톤 UI)는 세 구역으로 구성됩니다 —
**① 앙상블 소스별 비교**(결합·뮤추얼펀드·헤지펀드), **② 뮤추얼펀드 유니버스 · 개별 시그널**,
**③ 헤지펀드 유니버스 · 개별 시그널**. 각 카드에 2024–2026 누적수익 vs S&P 500 차트, 검증
통계(알파·t·Sharpe), 리밸런싱 이후 실시간 성과, 종목별 **비중**·이후수익을 표시하고, 하단에
시그널·소스 설명을 담았습니다.
